    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            className: 'jsx-' + _MessageModal2.default.__scopedHash + ' ' + ('host' + (this.state.open ? ' fadeIn' : ''))
          },
          _react2.default.createElement(
            'div',
            {
              className: 'jsx-' + _MessageModal2.default.__scopedHash + ' ' + 'modal'
            },
            _react2.default.createElement(
              'div',
              {
                className: 'jsx-' + _MessageModal2.default.__scopedHash + ' ' + 'message'
              },
              this.props.message
            ),
            _react2.default.createElement(
              'div',
              {
                className: 'jsx-' + _MessageModal2.default.__scopedHash + ' ' + 'buttons'
              },
              this.props.buttons.map(function (button, index) {
                var onClick = button.onClick,
                    ...
                    label = button.label,
                    icon = button.icon,
                    props = _objectWithoutProperties(button, ['onClick', 'onAfterClose', 'label', 'icon']);
